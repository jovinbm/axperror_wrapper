module.exports = function (Axperror_wrapper) {
   ...
   * @class axpError
   * @param {object}      opts
   * @param {boolean}     [opts.print=false] - whether to actually print the error
  ...
  var axpError = function (opts) {
    Error.captureStackTrace(this, GLOBAL.axpError);
    
    var self          = this;
    var allProperties = ['print', 'isHandled', 'isCustomError', 'reload', 'err', 'name', 'c_code', 'code', 'isPartial', 'message', 'msg', 'redirect', 'redirectPath', 'redirectUrl', 'logout', 'request', 'protocol'];
    ...
    if (err instanceof Error) {
      ...
      if (err.isCustomError) {
        ...
        self.isPartial     = "isPartial" in options ? !!options.isPartial : !!err.isPartial;
